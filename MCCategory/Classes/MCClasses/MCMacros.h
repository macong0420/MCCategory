...
#define MCWidthScale(x) ((x*MCScreenHeight)/667)
#define MCHeightScale(x) ((x*MCScreenWidth)/375)

#define ISIphone4S  ([UIScreen mainScreen].bounds.size.height == 480 ? YES : NO)

#define KSCALE (ISIphone4S?0.85:1)
